            ...
            <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <div className="inline-block rounded-lg bg-primary/10 px-3 py-1 text-sm text-primary font-semibold">Dinheiro na mão, sem dívida nova</div>
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">Antecipação do Saque-Aniversário FGTS</h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Use um dinheiro que já é seu para realizar seus planos. Antecipe até 10 parcelas do seu Saque-Aniversário FGTS de forma rápida, segura e com uma das menores taxas do mercado.
                  </p>
                </div>
                <ul className="grid gap-2 py-4">
                  <li><CheckCircle className="mr-2 inline-block h-4 w-4 text-primary" /> Não compromete sua renda mensal.</li>
                  <li><CheckCircle className="mr-2 inline-block h-4 w-4 text-primary" /> Dinheiro disponível em até 24 horas.</li>
                  <li><CheckCircle className="mr-2 inline-block h-4 w-4 text-primary" /> Sem consulta ao SPC/Serasa.</li>
                  <li><CheckCircle className="mr-2 inline-block h-4 w-4 text-primary" /> Totalmente digital e sem burocracia.</li>
                </ul>
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Button asChild size="lg">
                    <Link href="/cadastro?quiz=antecipacao-fgts">
                      Solicite agora
              ...
              <img src="https://picsum.photos/seed/fgts-money/600/600" alt="FGTS" data-ai-hint="brazilian money" className="mx-auto aspect-square overflow-hidden rounded-xl object-cover object-center sm:w-full" />
            </div>
          </div>
        </section>
