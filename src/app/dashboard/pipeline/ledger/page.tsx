...
export default function LedgerPage() {
  ...
  const clientsQuery = useMemoFirebase(() => {
    ...
    // Filter for clients in 'Ledger' status
    return query(collection(firestore, 'clients'), where('status', '==', 'Ledger'))
  }, [firestore])
      ...
      return (
        <TableRow>
          <TableCell colSpan={6} className="h-24 text-center">
            Nenhum cliente na esteira de pagamento.
          </TableCell>
        </TableRow>
      )
    }
    ...
    <>
       <Card className="mt-4">
          <CardHeader>
            ...
            <CardDescription>
              Confirme o recebimento do valor e anexe os boletos de pagamento.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
          ...
          <CardFooter>
            <div className="text-xs text-muted-foreground">
              ...
              clientes na esteira de pagamento.
            </div>
          </CardFooter>
        </Card>
    </>
